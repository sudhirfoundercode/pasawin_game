...
<div class="container-fluid mt-5">
    <form action="{{ route('redblack.store') }}" method="post">
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="row ml-4 d-flex" style="margin-bottom: 20px;">
                        ...
                        <div class="col-md-3 form-group d-flex">
                            <select name="number" class="form-control">
                                <option value="1"><b>Red</b></option>
                                <option value="2"><b>Black</b></option>
                            </select>
                        </div>
                ...
                <form action="{{ route('redblackpercentage.update') }}" method="post">
                    @csrf
