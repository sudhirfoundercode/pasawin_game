...
<div class="container-fluid mt-1">
    ...
    <div class="row" style="background-color: #fff; border-radius: 5px; margin-bottom: 0px;">
        ...
        <div class="col-sm-6 d-flex align-items-center">
            <b class="city" style="font-weight: bold; font-size: 16px; margin-right: 5px;">Game Period Number -</b>
    ...
    <div class="table-responsive mt-5">
        <table class="table table-bordered" style="width: 100%; text-align: center;">
            <thead>
                <tr>
                    <!--<th><img src="https://npl.fctechteam.org/assets/card.png"></th>-->
                ...
                <tr>
                    ...
                    <td class="bg-danger-hover" onclick="point_details(1)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="jh" style="text-align: center;">10</h5>
                        </div>
                    </td>
                    ...
                    <td class="bg-danger-hover" onclick="point_details(2)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="js"style="text-align: center;">25</h5>
                        </div>
                    </td>
                    <td class="bg-danger-hover" onclick="point_details(3)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="jd"style="text-align: center;">39</h5>
                        </div>
                    </td>
                    <td class="bg-danger-hover" onclick="point_details(4)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="jc"style="text-align: center;">43</h5>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="bg-danger-hover" onclick="point_details(9)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="kh"style="text-align: center;">89</h5>
                        </div>
                    </td>
                    <td class="bg-danger-hover" onclick="point_details(10)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="ks"style="text-align: center;">51</h5>
                        </div>
                    </td>
                    <td class="bg-danger-hover" onclick="point_details(11)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="kd"style="text-align: center;">67</h5>
                        </div>
                    </td>
                    <td class="bg-danger-hover" onclick="point_details(12)" data-bs-toggle="modal" data-bs-target="#myModal">
                        <div style="position: relative;">
                            ...
                            <h5 class="p-3" id="kc"style="text-align: center;">69</h5>
                        </div>
                    </td>
                </tr>
            </tbody>
...
<form action="{{route('lucky12.update')}}" method="post">
            @csrf
...
function updateBets(bet_log,amount) {
    ...
    document.getElementById('jh').textContent = bet_log[0].amount;
    document.getElementById('js').textContent = bet_log[1].amount;
    document.getElementById('jd').textContent = bet_log[2].amount;
    document.getElementById('jc').textContent = bet_log[3].amount;
    document.getElementById('qh').textContent = bet_log[4].amount;
    document.getElementById('qs').textContent = bet_log[5].amount;
    document.getElementById('qd').textContent = bet_log[6].amount;
    document.getElementById('qc').textContent = bet_log[7].amount;
    document.getElementById('kh').textContent = bet_log[8].amount;
    document.getElementById('ks').textContent = bet_log[9].amount;
    document.getElementById('kd').textContent = bet_log[10].amount;
    document.getElementById('kc').textContent = bet_log[11].amount;
