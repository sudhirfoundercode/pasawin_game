            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Triple Chance Bets Records Table</h4>
                    </div>    
                    <form action="{{ route('triplechance.bets') }}" method="post">
                        @csrf
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><strong>Wheel No</strong></th>
                                            <th><strong>Win Amount</strong></th>
