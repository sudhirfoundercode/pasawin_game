...
<div class="container-fluid mt-3" style="margin-bottom: 60px;">
 <form action="{{route('andarbahar.store') }}" method="post">
        @csrf
        ...
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
                ...
                <div class="row" style="padding-top: 30px;  padding-bottom:20px;">
                        ...
                        <div class="card col-md-3 ml-3 mt-4 " style="background-image:url('https://admin.gameon.deals/admin/uploads/banner/tie.png'); height:300px;">
                            <div class="card-body" style="margin-top:120px">
                                <b style="font-size: 25px; margin-left:70px; "> {{$amounts[0]->Andar}} </b>
                            </div>
                        </div>
					 <div class="card col-md-3 ml-3 mt-4 " style="background-image:url('https://kingclub.co.in/admin/uploads/banner/tiger.png'); height:300px;">
                            <div class="card-body" style="margin-top:120px">
                                <b style="font-size: 25px; margin-left:70px;">{{$amounts[0]->Bahar}} </b>
                            </div>
                        </div>
