...
<div class="container py-5">
    <div class="custom-card">
        <div class="custom-header">
            <h3 class="mb-0"><i class="bi bi-shield-lock"></i> Today's IP Address Logs</h3>
        </div>
        <div class="p-4">
                ...
                <table id="ipTable" class="table table-hover table-striped align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="4" class="text-center text-muted">No IP logs found for today.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/pasawin.com/root.pasawin.com/resources/views/login_user_ip_detail/today.blade.php ENDPATH**/ ?>