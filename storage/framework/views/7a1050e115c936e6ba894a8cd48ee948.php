...
<div class="container mt-4">
    <h2 class="mb-4">IFSC Modifications</h2>
...
function approveIfsc(id) {
    Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to approve this IFSC modification?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            window.location.href = "/admin/ifsc-modification-approve/" + id;
        }
    });
}
...
function openRejectModal(id) {
    ...
    form.action = "/admin/ifsc-modification-approve/" + id;
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/pasawin.com/root.pasawin.com/resources/views/CustomerService/ifsc_modifications.blade.php ENDPATH**/ ?>