    ...
    <div class="white_shd full margin_bottom_30">
       <div class="full graph_head">
          <div class="heading1 margin_0 d-flex">
             <h2>Deposit List</h2>
             <!--<a href="<?php echo e(route('deposit.delete_all')); ?>" class="btn btn-danger" style="margin-left:620px;" role="button">All Delete</a>-->
					   ...
					   <td>
                                        ...
                                        <!--<div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												...
												<a class="dropdown-item" data-toggle="modal" data-target="#exampleModalCenter<?php echo e($item->id); ?>" style="background-color: Red; color: white;">
                                                                Reject
                                                            </a>
                                                ...
                                                <div class="modal fade" id="exampleModalCenter1<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?php echo e(route('payin_success', ['id' => $item->id])); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal fade" id="exampleModalCenter<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?php echo e(route('deposit.reject', ['id' => $item->id])); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="modal-body">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <!-- <td>-->
                      <!--  <a href="<?php echo e(route('deposit.delete',$item->id)); ?>"><i class="fa fa-trash mt-1 ml-1" style="font-size:30px;color:red;" ></i></a>-->
                      <!--</td>-->
                 </tr>    
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/pasawin.com/root.pasawin.com/resources/views/work_order_assign/deposit.blade.php ENDPATH**/ ?>