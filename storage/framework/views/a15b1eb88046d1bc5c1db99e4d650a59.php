...
<div class="container-fluid py-5">
  ...
  <div class="mode-tab-group">
    <?php $__currentLoopData = $gameModes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      ?>
      <a style="border-radius:12px;" href="<?php echo e(route('trx2', $mode->id)); ?>" class="<?php echo e($isActive ? 'active' : ''); ?>">
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/pasawin.com/root.pasawin.com/resources/views/trx2_prediction/index.blade.php ENDPATH**/ ?>